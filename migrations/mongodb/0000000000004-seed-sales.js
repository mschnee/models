...
module.exports.description = 'Adds default hrm, qa2@bambee.com';
...
module.exports.down = async function () {
  ...
  log('Reverting 0000000000004-seed-sales');
  const db = await connect();
